...
public class FavMovieWidget extends AppWidgetProvider {
	...
	private static final String TOAST_ACTION = "com.programmer.moviecatalogue.TOAST_ACTION";
	public static final String EXTRA_ITEM = "com.programmer.moviecatalogue.EXTRA_ITEM";
